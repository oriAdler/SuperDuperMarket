var chatVersion = 0;
var chatRefreshRate = 2000; //milli seconds
...
function appendChatEntry(index, entry){
    ...
    $("#chatarea").prepend(entryElement).prepend("<br>");
}
...
function triggerAjaxChatContent() {
    setTimeout(ajaxChatContent, chatRefreshRate);
}
...
$(function (){
    $("#chatDropDownButton").click(function(){
        let dropDown = document.getElementById("chatDiv");
